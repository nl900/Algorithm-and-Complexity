...
2) Conquer: sort the subarrays created in the divide step. Recursively sort the subarray, that is, if it has more than 2 elements
and it's no the base case, then it is divided into subarrays again until base case of size 1.
